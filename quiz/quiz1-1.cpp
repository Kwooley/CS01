...
int		checkoverlap(int x1, int x2, int x3, int x4, int x5, int x6)
{
	if (checktwolines(x1, x2, x3, x4) )
		return 1;
	if (checktwolines(x2, x3, x5, x6) )
		return 1;
	if (checktwolines(x1, x2, x5, x6) )
		return 1;
	return 0; 
}
int		checktwolines(int x1, int x2, int x3, int x4)
{
	int flag =1;
	if ( x1 < x3 ) 
	{
